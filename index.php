...
<div class="conteudo4">
<a href="login.php" class="btn-more">Acessar</a>
...
<div class="btn-social">
    ...
    <div id="popup">
        ...
        <h4>Aviso</h4>
        <p>Nossas funções funcionam melhor em telas maiores. Caso esteja no celular, se possível, acesse em um desktop para melhor experiência</p>
    </div>
